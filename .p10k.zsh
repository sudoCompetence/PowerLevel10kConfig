# Generated by Powerlevel10k configuration wizard on 2023-11-19 at 20:04 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%232F' # black foreground
      local   modified='%232F' # black foreground
      local  untracked='%232F' # black foreground
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=231
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=232
